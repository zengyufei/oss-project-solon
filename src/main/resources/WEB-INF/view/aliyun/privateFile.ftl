        ...
        $.get("/api/file/list?orderByField=" + orderByField + "&orderByType=" + orderByType, function (data) {
            ...
            if (data.data) {
                ...
                for (var i = 0; i < fileList.length; i++) {
                    ...
                    var urlTdDom = $('<td></td>')
                    urlTdDom.append('<a href="' + file.url + '&size=' + file.size + '">' + file.fileName + '</a>')
                    ...
                    var delTdDom = $('<td></td>')
                    delTdDom.append('<input type="button" style="margin-left: 10px;" value="删除" onclick="del(\'del_' + i + '\', \'' + file.fileName + '\');"/>')
                    ...
                    if (file.shortUrl) {
                        ...
                        shortTextTdDom.append('<a id="short_' + i + '" href="http://'+file.shortUrl+'">'+file.shortUrl+'</a>')
